...
class Task(models.Model):
    ...
    valor_total_processo = models.DecimalField(max_digits=10, decimal_places=2, blank=True, null=True)  # Novo campo
    valor_advogado = models.DecimalField(max_digits=10, decimal_places=2, blank=True, null=True)  # Novo campo
